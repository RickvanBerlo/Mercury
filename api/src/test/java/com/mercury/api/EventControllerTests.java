...
public class EventControllerTests {
        ...
        public void addEvents() {
                String title = "test";
                Event events = eventsController.createEvent(new Event(title, "testing", false, LocalDate.now(),
                                LocalDate.now(), "#ffffff", LocalTime.now(), LocalTime.now())).getBody();
        ...
        public void getEvent() {
                String title = "test";
                Event event = eventsController.createEvent(new Event(title, "testing", false, LocalDate.now(),
                                LocalDate.now(), "#ffffff", LocalTime.now(), LocalTime.now())).getBody();
        ...
        public void replaceEvent() {
                ...
                String id = eventsController.createEvent(new Event("old", "testing", false, LocalDate.now(),
                                LocalDate.now(), "#ffffff", LocalTime.now(), LocalTime.now())).getBody().getId();
                Event event = eventsController.replaceEvent(id, new Event(title, "testing", false, LocalDate.now(),
                                LocalDate.now(), "#ffffff", LocalTime.now(), LocalTime.now())).getBody();
