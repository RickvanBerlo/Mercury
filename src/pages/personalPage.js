...
const CurriculemVitae = () => {
  ...
  return (
    <ParallaxProvider>
      ...
      {/* parallax */}
      <Header name={strings.NAME} links={strings.WEBLINKS} nextSection={strings.NAVIGATION[1].PRIVATE_NAME} layers={[LayerFive, LayerFour, LayerThree, LayerTwo, LayerOne]} mobile={[backgroundMobile, background]} />
